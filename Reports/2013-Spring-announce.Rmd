...
* **Feb 19**: Introduction, data files, documentation markup and elementary data visualization
* **Feb 26**: Relational database operations, intermediate data visualization
* **Mar 5**: More data operations, map visualization
* **Mar 12**:  Basic models, fitting, and summaries
* **Mar 26**: Clustering
* **Apr 9**: Dimension reduction
