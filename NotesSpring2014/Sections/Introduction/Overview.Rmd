...
You'll study several important graphical forms for data, learn some components of effective and truthful communication with graphics, and deconstruct the graphics to understand the structure of the data behind them.   You'll find that once you have a proper arrangement of data, the technical part of generating a graphic is easy.  What requires insight and creativity is arranging an effective correspondence between the elements of data and the components of the graphics.
