...
* Data across many files: Example: [Gapminder](www.gapminder.org/data)
* `r I(gitHTML(label="Wide and Narrow Data",nm="WideVsLong", folder="Notes/Day3/"))`
* Continuous to Categorical (to be posted)
...
Topic | Instructions | Template | Hand in on Moodle
------|--------------|----------|------------------
Maps |  `r I(gitHTML(nm="map-exercises", folder="Notes/Day3/"))` | `r I(template(nm="map-exercises",folder="Notes/Day3/"))` | `r I(handin("W3maps"))`
