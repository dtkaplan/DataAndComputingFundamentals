...
Topic | Instructions | Template | Hand in on Moodle
------|--------------|----------|------------------
Exercises | `r I(gitHTML(nm="Exercises-4", folder="Notes/Day4/"))` | `r I(template(nm="Exercises-4",folder="Notes/Day4/"))` | `r I(handin("W3exercises"))`
...
* `r I(gitHTML(label="Graphics: Parallel Coordinates",nm="Parallel Coordinates",folder="Notes/Day5/"))`
